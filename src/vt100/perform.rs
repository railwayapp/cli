...
pub struct WrappedScreen<CB: super::callbacks::Callbacks = ()> {
...
impl<CB: super::callbacks::Callbacks> WrappedScreen<CB> {
    pub fn new_with_callbacks(rows: u16, cols: u16, scrollback_len: usize, callbacks: CB) -> Self {
        Self {
            screen: super::screen::Screen::new(super::grid::Size { rows, cols }, scrollback_len),
            callbacks,
        }
    }
}

impl<CB: super::callbacks::Callbacks> vte::Perform for WrappedScreen<CB> {
    ...
    fn csi_dispatch(&mut self, params: &vte::Params, intermediates: &[u8], _ignore: bool, c: char) {
        let unhandled = |screen: &mut super::screen::Screen| {
