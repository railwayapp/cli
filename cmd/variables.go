...
func (h *Handler) VariablesSet(ctx context.Context, req *entity.CommandRequest) error {
	...
	err = h.maybeRedeployAfterVariablesChange(ctx, environment)
	if err != nil {
		return err
	}
...
func (h *Handler) maybeRedeployAfterVariablesChange(ctx context.Context, environment *entity.Environment) error {
	...
	ui.StopSpinner(ui.AlertInfo("Deploy successful"))
	return nil
}
